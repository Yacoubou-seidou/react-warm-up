...
# 📖 [react-warm-up] <a name="about-project"></a>

**[react-warm-up]** it is a repository for training  (add, delete, show by categories).
...
```sh
  cd my-folder
  git clone https://github.com/Yacoubou-seidou/react-warm-up.git
```
...
Feel free to check the [issues page](https://github.com/Yacoubou-seidou/react-warm-up/issues).
